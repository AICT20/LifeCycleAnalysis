...
public interface IAbstractionPathBuilder extends IMemoryBoundedSolver {
	 ...
	 */
    interface OnPathBuilderResultAvailable {
		 ...
		 */
        void onResultAvailable(ResultSourceInfo source, ResultSinkInfo sink);
	 ...
	 */
    void computeTaintPaths(final Set<AbstractionAtSink> res);
	 ...
	 */
    void addResultAvailableHandler(OnPathBuilderResultAvailable handler);
