...
public class KillPatternIrrelevantSource extends AbstractTaintPropagationRule {
    public KillPatternIrrelevantSource(InfoflowManager manager, Abstraction zeroValue, TaintPropagationResults results) {
