...
public class LCFinishPropagationRule extends AbstractLCStatePropagationRule {
    ...
    //finish时只可能是onCreate, onStop等生命周期函数的最后一步
    @Override
...
//            if (null != source.getDef() && source.getDef().getField().getName().contains("mGoogleApiClient") && source.getEntryMethod().getName().contains("onCreate")) {
//                System.out.println();
//            }
