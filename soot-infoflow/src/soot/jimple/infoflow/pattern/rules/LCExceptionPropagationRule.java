...
public class LCExceptionPropagationRule extends AbstractLCStatePropagationRule  {
    public LCExceptionPropagationRule(PatternInfoflowManager manager, LCMethodSummaryResult results) {
