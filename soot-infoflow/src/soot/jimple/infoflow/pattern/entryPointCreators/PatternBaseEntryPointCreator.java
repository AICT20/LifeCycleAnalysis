...
public class PatternBaseEntryPointCreator extends BaseEntryPointCreator {
    ...
    public PatternBaseEntryPointCreator(SootClass activityClass,  MultiMap<SootClass, String> activityLifecycleCallbacks) {
...
//    protected void createClassInstances(Collection<SootClass> classes, Body body) {
...
//    }
//
//    protected Stmt createIfStmt(Unit target, Body body) {
//        if (target == null) {
//            return null;
//        }
